...
class CDFPlotter:
    def __init__(self):
        ...
        self.policy_names = {
            ...
            'showvar': 'ShowVar',
            'ap': 'AutoPilot',
            'elasticcontainer': 'Elastic Container',
            "default": "Default",
        }
    ...
    def detect_policy_from_filename(self, filename):
        ...
        if 'autothrottle' in filename or '_at' in filename:
            return 'at'        
        elif 'default' in filename:
            return 'default'
        elif 'showvar' in filename or 'show_var' in filename or '_sw' in filename:
            return 'sw'
        elif '_ap' in filename or 'autopilot' in filename:
            return 'autopilot'
        elif '-ap' in filename:
            return 'ap'
        elif '_default' in filename:
            return 'default'
        elif "_ec" in filename or "elasticcontainer" in filename:
    ...
    def detect_policy_from_columns(self, df):
        ...
        for col in columns:
            if 'autothrottle' in col or '-ap' in col:
                return 'autothrottle'
            elif 'default' in col or '_default ' in col:
                return 'default'
            elif 'showvar' in col or '_sw' in col:
                return 'showvar'
            elif 'autopilot' in col or '_ap' in col:
                return 'autopilot'
            elif 'elasticcontainer' in col or '_ec' in col:
                return 'elasticcontainer'
        return 'unknown'
