...
class CDFPlotter:
    def __init__(self):
        ...
        self.policy_names = {
            ...
            'showvar': 'ShowVar',
            'static': 'Static',
            'elastic-container': 'ElasticContainer',
            'autopilot': 'AutoPilot',
            'ap': 'AutoPilot',
        }
    ...
    def detect_policy_from_filename(self, filename):
        ...
        if 'autothrottle' in filename or '_at' in filename:
            ...
            return 'ap'
        elif '_ec' in filename or 'elastic-container' in filename:
            return 'elastic-container'
        elif '_static' in filename or 'static' in filename:
            return 'static'
        else:
