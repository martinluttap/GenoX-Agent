...
for response_time_ms column. Automatically filters for successful requests only (success=True).
"""
...
def main():
    ...
    # Print statistics
    print("\n" + "="*50)
    print("RESPONSE TIME STATISTICS (SUCCESSFUL REQUESTS ONLY)")
    print("="*50)
    print(f"Total successful requests: {stats['count']:,}")
